 ...
 let play = message.client.manager.players.get(message.guild.id)
  ...
  if (!args.length) {
    let embed = new MessageEmbed()
      .setColor("343434")
      .setDescription(`To play a song, you need to specify which song you want to play! Try a/play with out me`)
 ...
 if (channel.id !== player.voiceChannel) {
  ...
  try {
    ...
    let embed = new MessageEmbed()
      ...
      .setDescription(`<:Cross:885767422727061504> i can't find result about \`${search}\``
       )
    return message.channel.send(embed)
  }
  ...
  switch (res.loadType) {
    case 'NO_MATCHES':
      ...
      let embed = new MessageEmbed()
        ...
        .setDescription(`<:Cross:885767422727061504> i can't find results about \`${search}\``)
      return message.channel.send(embed)
    ...
    case 'TRACK_LOADED':
      ...
      let embed2 = new MessageEmbed()
        .setColor("343434")
        .setTitle(`__Queued__`)
        .setDescription(`__[${res.tracks[0].title}](${res.tracks[0].uri})__`)
