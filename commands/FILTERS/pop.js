...
if (!args[0]) {
	player.setEQ([{
        ...
        const msg = await message.channel.send(`<a:dark:866726600028061706> Turning on **pop**.`);
		...
		const msg = await message.channel.send(`<a:Dot:873462741757755442> Turning off **pop**.`);
			const embed = new MessageEmbed()
