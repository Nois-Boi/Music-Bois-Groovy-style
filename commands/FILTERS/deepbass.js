...
player.setEQ([{
        ...
        const msg = await message.channel.send(`<a:dark:866726600028061706> Turning on **deepbass**.`);
		...
		player.clearEffects()
		const msg = await message.channel.send(`<a:dark:866726600028061706> Turning off **deepbass**.`);
			const embed = new MessageEmbed()
