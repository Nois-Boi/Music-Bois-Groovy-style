...
return 
 ...
 players.connect()*/
  ...
  client.manager.on("trackStart", (player, track) => {
    ...
    .setColor("343434")
   .setAuthor(`NOW PLAYING`,'https://cdn.discordapp.com/attachments/853934727144800267/884440929291894844/ezgif-2-5ff5c19dfc64.gif')
...
channel.send(np).then(m => m.delete({ timeout: track.duration }));
 ...
 client.manager.on("queueEnd", player => {
    ...
    channel.send({embed: {
      color: "343434",
      description:"<:musical:882611294358888499> Queue has ended."}});
    player.destroy();
  });
